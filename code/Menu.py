...
class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/Menu.jpg').convert_alpha()
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(50, "Corra", COLOR_ORANGE, ((WIN_WIDTH / 2), 80))
            self.menu_text(50, "Dino", COLOR_ORANGE, ((WIN_WIDTH / 2), 120))
    ...
    def menu_text(self, text_size: int, text: str, text_color: tuple, text_center_pos: tuple):
        text_font: Font = pygame.font.SysFont(name="Bazooka", size=text_size)
